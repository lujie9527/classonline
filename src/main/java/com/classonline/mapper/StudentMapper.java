...
import com.classonline.bean.Docdownload;
import com.classonline.bean.Student;
import com.classonline.bean.TeacherJob;
...
public interface StudentMapper {
	...
	@Results({
		@Result(column="docdetailId",property="docdetail",one=@One(select="com.classonline.mapper.DocMapper.getDocdetailById"))
	})
	...
	void addGrade(@Param("grade") Integer grade,@Param("id") String id);
}
