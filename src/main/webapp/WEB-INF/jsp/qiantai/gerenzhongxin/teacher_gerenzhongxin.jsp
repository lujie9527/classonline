                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item">
                        <a href="javascript:;" data-id="1" data-title="个人信息"
                           data-url="${pageContext.request.contextPath }/gerenzhongxin/teacher/gerenxinxi"
                           class="site-demo-active" data-type="tabAdd">个人信息</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;" data-id="2" data-title="上传资料"
                           data-url="${pageContext.request.contextPath }/gerenzhongxin/teacher/doc"
                           class="site-demo-active" data-type="tabAdd">上传资料</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;" data-id="3" data-title="上传教学视频"
