...
<div class="container">
    <ul class="pagination justify-content-center">
    	...
    	<c:if test="${pageInfo.hasPreviousPage }">
    		<li class="pages-item">
                <a class="pages-link" href="${pageContext.request.contextPath }/video/all?pageNum=${pageInfo.pageNum-1}&keyword=${keyword}">&laquo;</a>
            </li>
    	</c:if>
     	...
     	<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
     		<c:if test="${pageInfo.pageNum ==page_num }">
     			<li class="pages-item active">
                    <a class="pages-link" href="${pageContext.request.contextPath }/video/all?pageNum=${page_num }&keyword=${keyword}">${page_num }</a>
                </li>
     		</c:if>
     		<c:if test="${pageInfo.pageNum !=page_num }">
     			<li class="pages-item">
      ...
      <c:if test="${pageInfo.hasNextPage }">
    	<li class="pages-item">
            <a class="pages-link" href="${pageContext.request.contextPath }/video/all?pageNum=${pageInfo.pageNum+1}&keyword=${keyword}">&raquo;</a>
        </li>
    </c:if>
    
    <c:if test="${pageInfo.size>0}">
    		<li class="pages-item">
                <a class="pages-link" href="${pageContext.request.contextPath }/video/all?pageNum=${pageInfo.pages }&keyword=${keyword}">末页</a>
            </li>
    	</c:if>
  </ul>
</div>
