...
<head>
    ...
    <script type="javascript" src="${pageContext.request.contextPath}/js/pdfobject.js"></script>
    <script type="javascript" src="${pageContext.request.contextPath}/js/pdfobject.min.js"></script>
    <style>
        .copyright p {
            height: 50px;
            font-size: 12px;
