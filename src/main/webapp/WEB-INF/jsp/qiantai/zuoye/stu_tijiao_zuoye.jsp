  ...
  <div class="container">
   ...
   <div class="container">
        ...
        <div class="col-md-2 text-center" style="margin-top:10px;">
            ...
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath }/job/all" style=" width:120px;">下载作业</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="${pageContext.request.contextPath }/job/stu/show_tijiao" style=" width:120px;">提交作业</a>
            </li>
          </ul>
        </div>
