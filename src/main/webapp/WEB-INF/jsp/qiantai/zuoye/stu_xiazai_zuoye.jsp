        ...
        <div class="row">
            ...
            <div class="col-md-2 text-center" style="margin-top:10px;">
                <ul class="nav nav-tabs flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath }/job/all"
                           style=" width:120px;">下载作业</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath }/job/stu/show_tijiao"
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${pageInfo.list}" var="job" varStatus="vs">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/download/job?filename=${job.url}">下载</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
    ...
    <div class="container">
        <ul class="pagination justify-content-end">
            <c:if test="${pageInfo.size>0 }">
                <li class="pages-item">
                    <a class="pages-link" href="${pageContext.request.contextPath }/job/all?pageNum=1">首页</a>
                </li>
            </c:if>
            <c:if test="${pageInfo.hasPreviousPage }">
                <li class="pages-item">
                    <a class="pages-link"
                       href="${pageContext.request.contextPath }/job/all?pageNum=${pageInfo.pageNum-1}">&laquo;</a>
                </li>
            </c:if>
            ...
            <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                <c:if test="${pageInfo.pageNum ==page_num }">
                    <li class="pages-item active">
                        <a class="pages-link"
                           href="${pageContext.request.contextPath }/job/all?pageNum=${page_num }">${page_num }</a>
                    </li>
                </c:if>
                <c:if test="${pageInfo.pageNum !=page_num }">
                    <li class="pages-item">
            ...
            <c:if test="${pageInfo.hasNextPage }">
                <li class="pages-item">
                    <a class="pages-link"
                       href="${pageContext.request.contextPath }/job/all?pageNum=${pageInfo.pageNum+1}">&raquo;</a>
                </li>
            </c:if>
            ...
            <c:if test="${pageInfo.size>0}">
                <li class="pages-item">
                    <a class="pages-link"
                       href="${pageContext.request.contextPath }/job/all?pageNum=${pageInfo.pages }">末页</a>
                </li>
            </c:if>
        </ul>
    </div>
