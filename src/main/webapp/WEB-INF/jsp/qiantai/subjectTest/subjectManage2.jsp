    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item">
                    <a href="javascript:;" data-id="1" data-title="管理试题"
                       data-url="${pageContext.request.contextPath}/sub/allSub"
                       class="site-demo-active" data-type="tabAdd">管理试题</a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" data-id="2" data-title="增加试题"
                       data-url="${pageContext.request.contextPath}/sub/addSub"
                       class="site-demo-active" data-type="tabAdd">增加试题</a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" data-id="3" data-title="查询试题"
                       data-url="${pageContext.request.contextPath}/sub/findSub"
                       class="site-demo-active" data-type="tabAdd">查询试题</a>
                </li>
            </ul>
        </div>
    </div>
