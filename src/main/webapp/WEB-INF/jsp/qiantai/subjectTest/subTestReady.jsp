...
<h1 style="text-align: center">
    <a href="${pageContext.request.contextPath }/sub/getSubList">我准备好了，马上进入在线答题</a>
</h1>

<h3 style="text-align: center">温馨提示：本次考试时间为120分钟，请同学们在时间到之前交卷。</h3>
<h3 style="text-align: center">若时间到未交卷，系统将会自动交卷。</h3>
