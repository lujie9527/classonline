...
<table width="1003" height="485" class="layui-table">
    <tr>
        ...
        <td width="741" valign="top" class="rightbian">
            <table width="60%" align="center" cellpadding="10" cellspacing="0" border="1"  class="layui-table">
                ...
                <tr>
                    <td height="49" colspan="2"><div align="center"><span class="STYLE4"><strong>学生</strong>考试情况表</span></div></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                </tr>
                <tr>
                    <td><div align="center">考试姓名:${sessionScope.user.name}</div></td>
                    <td><div align="center">考生得分:${student.grade}分</div></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div align="center">
