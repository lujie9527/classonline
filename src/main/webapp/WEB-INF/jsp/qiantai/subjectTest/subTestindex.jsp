...
<%--                     sessionScope.xx == session.getAttribute("xx");--%>
                    ...
                    <c:forEach items="${subjectList}" var="subject" varStatus="sta">
                        <tr>
                            ...
                            <input type="hidden" name="subjectId" value="${pageContext.request.contextPath}/sub/getSubList/${subject.subjectId}"/>
                            <td colspan="3">
...
<script>
    $("button[name='submitTest']").click(function () {
        var data = [];
        // var subjectAn = $("form").serializeArray();把form表单的值全部转化为json格式：name:    value:
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $("div[name='rs']").html(subjectAnswer);
                window.location.href="${pageContext.request.contextPath}/qiantai/subjectTest/examResult";
            },
            error:function () {
                alert("提交失败");
            }
