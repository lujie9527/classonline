...
<div class="easyui-window" title="添加新班级" id="addBanjiWindow" collapsible="false" minimizable="false" maximizable="false"
        ...
        <form id="banjiForm" action="${pageContext.request.contextPath }/admin/banji/addOrUpdate" method="post">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr id="bianhao">
                    <td>班级编号</td>
                    <td>
                        <input id="id" type="text" name="id" class="easyui-validatebox"/>
                    </td>
                </tr>
                <tr>
                    <td>名称</td>
